...
define(function() {
    ...
    def.copyOwn(def, {
        ...
        copyProps: function(a, b, props) {
            ...
            if (props) {
                ...
                if (from) for (var prop; ++i < L; ) to[prop = props[i]] = from[prop]; else for (;++i < L; ) to[props[i]] = void 0;
            }
            return to;
        },
        keys: function(o) {
    ...
    def.array = {
        ...
        insert: function(array, item, comparer) {
            ...
            0 > index ? array.splice(~index, 0, item) : array[index] !== item && array.splice(index + 1, 0, item);
            return index;
        },
