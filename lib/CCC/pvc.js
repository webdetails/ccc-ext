...
define([ "./def", "./protovis-compat!", "./cdo", "jquery", "./tipsy" ], function(def, pv, cdo, $) {
    ...
    function slidingWindow_defaultSelect(datums) {
        ...
        if (L > 0) for (var dimName = this.dimension, dim = this.chart.data.dimensions(dimName), maxAtom = dim.max(), mostRecent = maxAtom ? maxAtom.value : null, maxLength = this.length, i = 0; L > i; i++) {
    ...
    function visRoleBinder_assertUnboundRoleIsOptional(role) {
        if (role.isRequired) throw def.error.operationInvalid("The required visual role '{0}' is unbound.", [ role.name ]);
    }
        ...
        methods: {
                    ...
                    if (mainDimType.isDiscrete) {
                        ...
                        if (!dimSpecs || !dimSpecs.comparer) {
                            ...
                            if (!dimGroupSpecs || !dimGroupSpecs.comparer) {
                                var visualRoles = chart.visualRolesOf(mainDimName, !0);
                                visualRoles && mainDimType.setComparer(def.ascending);
                            }
                        }
                    }
                });
            ...
            setAxesDefaults: function(chart) {
                chart.axesList.forEach(function(axis) {
                    var role = axis.role;
                    if (role) {
                        role.grouping.isSingleDimension && role.grouping.singleDimensionName === this.dimension && this._setAxisFixedRatio(axis);
    ...
    def.type("pvc.visual.Role").init(function(chart, name, keyArgs) {
        ...
        get isMeasureEffective() {
            return this.isMeasure ? this.isBound() ? !this.isDiscrete() : null : !1;
        },
        isDiscrete: function() {
            var g = this.grouping;
    ...
    pvc.visual.rolesBinder = function() {
        function phase_init() {
            ...
            context.query().each(function(role) {
                var opts = context.getOptions(role), isNotSourcedOrBound = void 0 === opts || !configureRole(role, opts);
                isNotSourcedOrBound && tryToSourceRoleFromMainRole(role);
            });
        ...
        function tryToSourceRoleFromMainRole(role) {
            var mainRole = context(role.name), isSecondaryRole = mainRole !== role;
        ...
        function preBindRoleToGrouping(role, grouping) {
            ...
            grouping.isNull ? visRoleBinder_assertUnboundRoleIsOptional(role) : grouping.dimensionNames().forEach(function(mainDimName) {
        ...
        function roleIsUnbound(role) {
            visRoleBinder_assertUnboundRoleIsOptional(role);
    ...
    def.type("pvc.visual.RoleVarHelper").init(function(rootScene, roleName, role, keyArgs) {
        ...
        this.isSingleNumberDimension = !1;
        if (null !== grouping) {
    ...
    def.type("pvc.visual.DataCell").init(function(plot, axisType, axisIndex, role) {
        ...
        isDataBoundOn: function(baseData) {
            var role = this.role;
            return role.isBound() ? role.isMeasureEffective ? role.isBoundDimensionCompatible(baseData) : !0 : !1;
        }
    });
    ...
    var pvc_Axis = def("pvc.visual.Axis", pvc.visual.OptionsBase.extend({
        ...
        methods: {
            ...
            _conciliateVisualRoles: function() {
                ...
                if (L > 1) {
                    ...
                    if ("discrete" === this.scaleType) {
                        ...
                        for (i = 1; L > i && possibleFlatteningModes; i++) {
            ...
            _calcDomainItems: function() {
                var domainData = this.domainData(), domainItems = [], domainValues = [], domainValuesSet = Object.create(null), hasOwn = def.hasOwnProp;
    ...
    def.type("pvc.BasePanel", pvc.Abstract).add(pvc.visual.Interactive).init(function(chart, parent, options) {
        ...
        _summaryTooltipFormatter: function(context) {
            ...
            function renderDim(mainDimType, value, valueLabel, aggregationType, interpolationName) {
                var rowClasses = ttClasses("dim", "dimValueType-" + mainDimType.valueTypeName, "dim" + (mainDimType.isDiscrete ? "Discrete" : "Continuous"), aggregationType ? "dimAgg" : "", aggregationType ? "dimAgg-" + aggregationType : ""), percentVar = null, visRoles = getDimActiveVisualRoles(mainDimType), dimRolesHtml = visRoles ? visRoles.map(function(role) {
            ...
            function getDimActiveVisualRoles(mainDimType) {
                var mainDimName = mainDimType.name, roles = me.visualRolesOf(mainDimName, !0);
    ...
    def("pvc.visual.Plot", pvc.visual.OptionsBase.extend({
        ...
        methods: {
            ...
            getContinuousVisibleCellExtent: function(chart, valueAxis, valueDataCell) {
                ...
                var data = chart.visiblePlotData(this), valueDimNames = valueRole.grouping.dimensionNames();
                return valueAxis.scaleSumNormalized() ? {
                    min: 0,
                    max: Math.abs(valueRole.numberValueOf(data).value || 0)
                } : def.query(valueDimNames).select(function(valueDimName) {
                    var useAbs = valueAxis.scaleUsesAbs(), extent = data.dimensions(valueDimName).extent({
                        abs: useAbs
                    });
                    if (void 0 !== extent) {
            ...
            _getColorDataCell: function() {
                ...
                return colorRole ? new pvc.visual.ColorDataCell(this, "color", this.option("ColorAxis") - 1, colorRole) : void 0;
            }
        },
        options: {
            Orientation: {
        ...
        _createDataCellPanel: function(dataCell, legendPanel, pvSymbolPanel, dataPartDimName) {
            ...
            if (colorRole.grouping.hasExtensionComplexTypes) {
                isBoundDimensionCompatibleList = colorRole.grouping.extensionDimensions().select(function(dimSpec) {
                    ...
                    return null !== measureRoleName && null !== (measureRole = plot.visualRole(measureRoleName)) ? measureRole.isBoundDimensionCompatible.bind(measureRole) : void 0;
    ...
    pvc.BaseChart.add({
        ...
        visualRolesOf: function(mainDimName, includePlotLevel) {
            ...
            if (!visualRolesByDim) {
                ...
                isAfterVisualRoleBinding && (this._visRolesByDim = visualRolesByDim);
                this.visualRoleList.forEach(function(role) {
    ...
    pvc.BaseChart.add({
        ...
        _getPreBoundTrendedDimensionNames: function() {
            return def.query(this.plotList).selectMany(def.propGet("dataCellList")).where(def.propGet("trend")).selectMany(function(dataCell) {
                return dataCell.role.isPreBound() ? dataCell.role.preBoundGrouping().dimensionNames() : void 0;
            }).distinct().array();
        },
        ...
        partData: function(dataPartValues, baseData) {
            ...
            var cacheKey = "\x00" + baseData.id + ":" + def.nullyTo(dataPartValues, ""), partitionedDataCache = def.lazy(rootChart, "_partsDataCache"), partData = partitionedDataCache[cacheKey];
            if (!partData) {
    ...
    pvc.BaseChart.add({
        ...
        _maybeCreateLegendGroupScene: function(colorAxis, getRootScene, legendGroupBaseIndex, dataPartDimName) {
            ...
            colorAxis.domainItems().forEach(function(itemData) {
                if (null !== dataPartDimName) {
                    var dataPartAtomsInItemData = itemData.dimensions(dataPartDimName).atoms(), itemHasAnyVisibleDataCells = dataPartAtomsInItemData.some(function(dataPartAtom) {
                        return def.hasOwn(visibleDataCellsByDataPart, dataPartAtom.value);
                    });
                    if (!itemHasAnyVisibleDataCells) return;
                }
                if (null !== dataCellsWithExtensionComplexTypesToCheck) {
                    var isAtLeastOneDataCellVisible = def.query(dataCellsWithExtensionComplexTypesToCheck).any(function(dataCell) {
                    ...
                    if (!isAtLeastOneDataCellVisible) return;
                }
        ...
        _createContent: function(parentPanel, contentOptions) {
            this.plotList.forEach(function(plot) {
                (!this.parent || plot.isDataBoundOn(this.data)) && this._createPlotPanel(plot, parentPanel, contentOptions);
            }, this);
        },
    ...
    def.type("pvc.CartesianAbstract", pvc.BaseChart).init(function(options) {
        ...
        markEvent: function(sourceValue, label, options) {
            ...
            if (!o.forceHorizontalAnchor) {
                var alignRight = "right" === ha, availableSize = alignRight ? baseEndPos - basePos : basePos, labelSize = pv.Text.measureWidth(label, o.font);
                ...
                if (InterpType) {
                    ...
                    if (visibleData.childCount() > 0) {
                        ...
                        valueDimNames.forEach(function(valueDimName) {
                            new InterpType(baseData, partData, visibleData, this.visualRoles.category, this.visualRoles.series, valueDimName, !0).interpolate();
                        }, this);
                    }
                }
            },
            ...
            generateTrendsDataCell: function(newDatums, dataCell, baseData) {
                ...
                if (0 !== yDimNames.length) {
                    ...
                    var datumDimNames, sumKeyArgs = {
                        ...
                        visible: !0
                    }).childNodes, partData = this.chart.partData(dataCell.dataPartValue, baseData), visibleSeriesDatas = seriesRole.flatten(partData, {
                        visible: !0
                    }).children().array();
    ...
    def.type("pvc.PointPanel", pvc.CategoricalAbstractPanel).init(function(chart, parent, plot, options) {
        ...
        _createCore: function() {
            ...
            var lineVisibleProp = dotsVisibleOnly ? !1 : isBaseDiscrete && isStacked && areasVisible ? sceneNotNullOrIntermProp : sceneNotNullProp, noLineInteraction = areasVisible && !linesVisible, pvLine = this.pvLine = new pvc.visual.Line(this, this.pvArea.anchor(this.anchorOpposite(anchor)), {
                extensionId: extensionIds,
                freePosition: !0,
                wrapper: wrapper,
